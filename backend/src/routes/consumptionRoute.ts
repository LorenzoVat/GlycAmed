...
import { consumptionSchema } from '@validation/consumptionSchema';
...
router.get('/all', authMiddleware, (req: Request, res: Response) => consumptionController.getAllConsumptions(req, res));
